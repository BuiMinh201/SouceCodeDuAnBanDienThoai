...
export const getProductCategory = (id,config)=>Http.get(`categories/${id}/products`,config);
...
export const createCommentsProduct = (id,data,config)=>Http.post(`products/${id}/comments`,data,config);
